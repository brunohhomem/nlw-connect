    ...
    <div className="min-h-dvh flex items-center justify-between gap-16 flex-col md:flex-row">
      <div className="flex flex-col gap-10 w-full max-w-[550px]">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-300">
            Para entrar no evento, acesse o link enviado para o e-mail
            cadastrado.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <InputRoot>
            ...
            <InputField
              readOnly
              defaultValue="http:localhost:3000/invite/ahdahjshuey123"
            />
      ...
      <div className="w-full max-w-[440px] space-y-5">
        ...
        <div className="space-y-4">
          ...
          <div className="relative rounded-xl bg-gray-700 border border-gray-600 p-6 flex flex-col justify-center gap-3">
            <span className="text-sm text-gray-300 leading-none">
              <span className="font-semibold">1°</span> | Butters Homem
            </span>
            <span className="font-heading text-2xl font-semibold text-gray-200 leading-none">
              99
            </span>
          ...
          <div className="relative rounded-xl bg-gray-700 border border-gray-600 p-6 flex flex-col justify-center gap-3">
            <span className="text-sm text-gray-300 leading-none">
              <span className="font-semibold">1°</span> | Bruno Homem
            </span>
            <span className="font-heading text-2xl font-semibold text-gray-200 leading-none">
              55
            </span>
